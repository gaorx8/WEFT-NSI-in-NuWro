...
PARAM(bool,sf_weft,1)\
PARAM(int,weft_param,0)\
PARAM(int,weft_individual_or_combined,0)\
PARAM(int,weft_individual_case,0)\
PARAM(double,weft_epi,0)\
PARAM(int,weft_combined_case,0)\
PARAM(bool,sf_fsi,1)\
