...
public:
  ...
  inline bool neutral_pion   ();            ///true if pion
  inline bool charged_pion   ();            ///true if pion
...
bool particle::neutral_pion()
{
  return pdg==111;
}

bool particle::charged_pion()
{
   return pdg==211 || pdg==-211;
}
